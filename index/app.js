...
document.addEventListener("DOMContentLoaded", () => {
    ...
    cardToggles.forEach((toggle, index) => {
        ...
        // Opsional: Buka seksi pertama (Data Anak) secara default saat halaman dimuat
        if (index === 0) {
            card.classList.add("active");
        }

        toggle.addEventListener("click", () => {
            // Jika ingin sistem hanya 1 card terbuka bergantian, aktifkan 2 baris di bawah ini:
            // cardToggles.forEach(t => t.closest(".glass-card").classList.remove("active"));
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            // Tutup semua card setelah sukses submit
